class Buy
  ...
  attr_accessor :postalcode, :state_id, :city, :address_number, :building_name, :phone_number, :user_id, :item_id

  validates :postalcode, :state_id, :city, :address_number, :phone_number, presence: true
